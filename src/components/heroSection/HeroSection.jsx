...
export default function HeroSection() {
  ...
  const slides = [
    ...
    },
    {
      ...
      image: "https://kinsta.com/wp-content/uploads/2024/08/performance-requirements-and-10-best-practices-for-high-speed-ecommerce-websites-1024x512.png",
      // image: image,
      cta: "#",
    },
  ];
  ...
  const comments = [
    { text: "Absolutely love the experience!", author: "@adebayo", color: "bg-cyan-400", top: "15%", left: "10%", rotate: "-3deg" },
    { text: "Seamless and intuitive!", author: "@mimisola", color: "bg-pink-500", top: "15%", left: "75%", rotate: "2deg" },
    { text: "Elegant and premium!", author: "@aminat", color: "bg-yellow-400", top: "70%", left: "10%", rotate: "-1deg" },
    { text: "Best online shopping ever.", author: "@zee", color: "bg-purple-400", top: "70%", left: "80%", rotate: "3deg" },
  ...
  return (
    <section className={`relative w-full ${bgColor} overflow-hidden`}>
        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-center text-white px-4">
              <h1 className="text-2xl sm:text-3xl font-bold drop-shadow-lg">{slide.title}</h1>
      ...
      <div className="hidden md:flex relative w-full h-screen flex-col justify-center items-center px-6 text-center">
        ...
        {/* Hero Text */}
        <h1 className={`relative text-6xl md:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-white to-pink-400 animate-textGlow leading-tight tracking-tight z-10 drop-shadow-lg`}>
          Elevate Your <span className={textColor}>Shopping Experience</span>
        </h1>

        <p className={`mt-6 text-xl md:text-2xl max-w-3xl drop-shadow-lg animate-fadeIn z-10 ${subTextColor}`}>
          Discover premium deals, curated collections, and a seamless online experience{" "}
          <span className="text-cyan-400 font-semibold">all at your fingertips.</span>
        </p>
        ...
        {comments.map((comment, index) => (
          ...
          >
            ...
            <span className="block text-gray-100 mt-1 text-xs">{comment.author}</span>
          </div>
        ))}
        ...
        <style jsx>{`
          ...
          .animate-textGlow { background-size: 200% 200%; animation: textGlow 6s ease infinite; }
...
//     },
//     {
//       text: "Curated collections are amazing!",
//       author: "@rayhaan",
//       color: "bg-green-400",
//       top: "40%",
//       left: "90%",
...
//   // Background colors depending on mode
//   const bgColor = mode === "dark" ? "bg-gray-900" : "bg-gray-50";
//   const textColor = mode === "dark" ? "text-white" : "text-gray-900";
//   const subTextColor = mode === "dark" ? "text-gray-300" : "text-gray-700";
...
//   return (
//     <section
//       className={`relative w-full h-screen flex flex-col justify-center items-center px-6 text-center overflow-hidden ${bgColor}`}
//     >
//       {/* Floating gradient shapes */}
//       <div className="absolute w-full h-full top-0 left-0 pointer-events-none">
//         {[...Array(8)].map((_, i) => (
