                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="leading-relaxed">
                                    <strong>AllMartStore</strong> is grateful for your continued patronage and support. We appreciate your trust in our products/services and are privileged to serve you.
                                </p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 style={{ color: mode === 'dark' ? '#ff4162' : '' }} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">AllMart_Store</h2>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  style={{color: mode === 'dark' ? 'white' : ''}}className="leading-relaxed">
                                AllMart Store has completely transformed my shopping experience — quality products, smooth checkout, and fast delivery all in one place.
                                </p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="leading-relaxed">
                                    Shopping at AllMart Store has been amazing — great prices, top-quality products, and excellent service every time.
                                </p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
